...
#RUN pip3 install opencv-python==4.1.0.25 torch==1.6.0 torchvision==0.7.0 numpy==1.18.4 pandas==0.24.1 networkx==2.2
#COPY requirements.txt .
#RUN pip3 install -r requirements.txt

#FROM kxnguyen/pytorch:pytorch17-transformers
#RUN pip3 install --force-reinstall transformers==4.5.1
#RUN pip3 install pytorch-transformers tensorboardX
