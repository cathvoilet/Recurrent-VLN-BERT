...
if __name__ == '__main__':
    ...
    input_file_list = ["snap/"+agent+"_pi_vote_outputs/random_ref_val_seen_eval.json" for agent in args.list]
    ...
    input_file_list = ["snap/"+agent+"_pi_vote_outputs/speaker_gpt2_db7_val_seen.json" for agent in args.list]
    print("Input file list: ", input_file_list)
    output_file = args.output_exp + "speaker_gpt2_db7_val_seen.json"
    print("Output file: ", output_file)
    vote_instructions(input_file_list, output_file)

    input_file_list = ["snap/"+agent+"_pi_vote_outputs/pi_vote-10ila_test-10vln_val_seen.json" for agent in args.list]
    print("Input file list: ", input_file_list)
    output_file = args.output_exp + "pi_vote-10ila_test-10vln_val_seen.json"
    print("Output file: ", output_file)
    vote_instructions(input_file_list, output_file)

    input_file_list = ["snap/"+agent+"_pi_vote_outputs/pi_vote-1ila_test-5vln_val_seen.json" for agent in args.list]
    print("Input file list: ", input_file_list)
